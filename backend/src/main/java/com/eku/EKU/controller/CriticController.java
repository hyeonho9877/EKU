...
public class CriticController {
    ...
    @PostMapping("/critic/search")
    public ResponseEntity<?> searchCritic(@RequestBody HashMap<String, String> data) {
        try {
    ...
    @PostMapping("/critic/search/specific")
    public ResponseEntity<?> searchSpecificCritic(@RequestBody CriticForm form) {
        try {
